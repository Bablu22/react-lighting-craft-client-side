        ...
        <div class="font-sans py-28 w-full flex flex-row justify-center items-center">
            <div class="card w-96 mx-auto bg-white  shadow-xl hover:shadow">
                {img !== null ? <img class="w-32 mx-auto rounded-full -mt-20 border-8 border-white" src={img} alt="" /> :
                    <img class="w-32 mx-auto rounded-full -mt-20 border-8 border-white bg-green-200" src={`https://www.gravatar.com/avatar/EMAIL_MD5?d=https%3A%2F%2Fui-avatars.com%2Fapi%2F/${name}/128`} alt="" />
                }
